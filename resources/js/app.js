...
// To Select all elemtents from HTML
...
// This is to get the user's country code 
...
// Here you have to use your own API key which you have to get from RapidAPI website
function fetchData(user_country){
	country_name_element.innerHTML = "Data loading...";
	...
	.then( data => {
		...
		dates.forEach( date => {
			...
			app_data.push(DATA);
			cases_list.push(parseInt(DATA.total_cases.replace(/,/g, ""))); // these are the formatting which needs to be done
...
// This function is to update the UI based on real-time data
function updateUI(){
	updateStats();
	axesLinearChart();
}
